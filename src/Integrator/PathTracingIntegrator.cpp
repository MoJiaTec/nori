...
static const std::string s_IntegratorName = "PathTracing";
...
{
public:
    PathTracingIntegrator(const PropertyList& props)
    {
    }
...
NORI_REGISTER_CLASS(PathTracingIntegrator, s_IntegratorName);
NORI_NAMESPACE_END